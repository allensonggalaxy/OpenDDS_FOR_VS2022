/* Generated by ..\bin\opendds_idl version 3.20.0 (ACE version 6.2a_p23) running on input file CorbaSeq\ULongLongSeq.idl */
...
template<> const XTypes::TypeIdentifier& getMinimalTypeIdentifier<CORBA_ULongLongSeq_xtag>()
{
  ...
  if (ti.kind() == XTypes::TK_NONE) {
    ti = XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(221, 114, 186, 153, 126, 127, 146, 163, 180, 160, 169, 68, 119, 29));
  }
  return ti;
}

static const XTypes::TypeMap& get_minimal_type_map();
template<> const XTypes::TypeMap& getMinimalTypeMap<CORBA_ULongLongSeq_xtag>()
{
...
{
  XTypes::TypeMap tm;
  tm[XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(221, 114, 186, 153, 126, 127, 146, 163, 180, 160, 169, 68, 119, 29))] = minimal_to0();
  return tm;
}
