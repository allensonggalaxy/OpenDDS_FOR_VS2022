/* Generated by ..\bin\opendds_idl version 3.20.0 (ACE version 6.2a_p23) running on input file CorbaSeq\CharSeq.idl */
...
template<> const XTypes::TypeIdentifier& getMinimalTypeIdentifier<CORBA_CharSeq_xtag>()
{
  ...
  if (ti.kind() == XTypes::TK_NONE) {
    ti = XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(224, 232, 22, 92, 221, 51, 14, 182, 164, 191, 182, 6, 85, 190));
  }
  return ti;
}

static const XTypes::TypeMap& get_minimal_type_map();
template<> const XTypes::TypeMap& getMinimalTypeMap<CORBA_CharSeq_xtag>()
{
...
{
  XTypes::TypeMap tm;
  tm[XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(224, 232, 22, 92, 221, 51, 14, 182, 164, 191, 182, 6, 85, 190))] = minimal_to0();
  return tm;
}
