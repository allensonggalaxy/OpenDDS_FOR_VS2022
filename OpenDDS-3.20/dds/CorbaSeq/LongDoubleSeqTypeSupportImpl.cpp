/* Generated by ..\bin\opendds_idl version 3.20.0 (ACE version 6.2a_p23) running on input file CorbaSeq\LongDoubleSeq.idl */
...
template<> const XTypes::TypeIdentifier& getMinimalTypeIdentifier<CORBA_LongDoubleSeq_xtag>()
{
  ...
  if (ti.kind() == XTypes::TK_NONE) {
    ti = XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(163, 74, 205, 216, 56, 230, 212, 208, 52, 212, 231, 154, 171, 243));
  }
  return ti;
}

static const XTypes::TypeMap& get_minimal_type_map();
template<> const XTypes::TypeMap& getMinimalTypeMap<CORBA_LongDoubleSeq_xtag>()
{
...
{
  XTypes::TypeMap tm;
  tm[XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(163, 74, 205, 216, 56, 230, 212, 208, 52, 212, 231, 154, 171, 243))] = minimal_to0();
  return tm;
}
