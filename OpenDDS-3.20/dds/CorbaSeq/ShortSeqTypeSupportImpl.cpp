/* Generated by ..\bin\opendds_idl version 3.20.0 (ACE version 6.2a_p23) running on input file CorbaSeq\ShortSeq.idl */
...
template<> const XTypes::TypeIdentifier& getMinimalTypeIdentifier<CORBA_ShortSeq_xtag>()
{
  ...
  if (ti.kind() == XTypes::TK_NONE) {
    ti = XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(61, 93, 138, 188, 116, 167, 242, 195, 45, 177, 21, 40, 103, 68));
  }
  return ti;
}

static const XTypes::TypeMap& get_minimal_type_map();
template<> const XTypes::TypeMap& getMinimalTypeMap<CORBA_ShortSeq_xtag>()
{
...
{
  XTypes::TypeMap tm;
  tm[XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(61, 93, 138, 188, 116, 167, 242, 195, 45, 177, 21, 40, 103, 68))] = minimal_to0();
  return tm;
}
