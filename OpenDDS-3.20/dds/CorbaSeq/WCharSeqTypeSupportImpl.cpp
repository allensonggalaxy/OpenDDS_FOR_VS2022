/* Generated by ..\bin\opendds_idl version 3.20.0 (ACE version 6.2a_p23) running on input file CorbaSeq\WCharSeq.idl */
...
template<> const XTypes::TypeIdentifier& getMinimalTypeIdentifier<CORBA_WCharSeq_xtag>()
{
  ...
  if (ti.kind() == XTypes::TK_NONE) {
    ti = XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(57, 224, 114, 228, 135, 225, 33, 200, 134, 203, 111, 197, 87, 108));
  }
  return ti;
}

static const XTypes::TypeMap& get_minimal_type_map();
template<> const XTypes::TypeMap& getMinimalTypeMap<CORBA_WCharSeq_xtag>()
{
...
void serialized_size(const Encoding& encoding, size_t& size, const  ::CORBA::WCharSeq& seq)
{
  ...
  primitive_serialized_size_wchar(encoding, size, seq.length());
}
...
{
  XTypes::TypeMap tm;
  tm[XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(57, 224, 114, 228, 135, 225, 33, 200, 134, 203, 111, 197, 87, 108))] = minimal_to0();
  return tm;
}
