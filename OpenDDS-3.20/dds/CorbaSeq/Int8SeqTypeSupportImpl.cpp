/* Generated by ..\bin\opendds_idl version 3.20.0 (ACE version 6.2a_p23) running on input file CorbaSeq\Int8Seq.idl */
#include "DCPS/DdsDcps_pch.h"
#include "Int8SeqTypeSupportImpl.h"
...
template<> const XTypes::TypeIdentifier& getMinimalTypeIdentifier<CORBA_Int8Seq_xtag>()
{
  ...
  if (ti.kind() == XTypes::TK_NONE) {
    ti = XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(249, 103, 63, 217, 56, 119, 202, 174, 215, 161, 55, 41, 163, 59));
  }
  return ti;
}

static const XTypes::TypeMap& get_minimal_type_map();
template<> const XTypes::TypeMap& getMinimalTypeMap<CORBA_Int8Seq_xtag>()
{
...
{
  XTypes::TypeMap tm;
  tm[XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(249, 103, 63, 217, 56, 119, 202, 174, 215, 161, 55, 41, 163, 59))] = minimal_to0();
  return tm;
}
