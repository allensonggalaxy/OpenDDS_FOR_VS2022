...
#ifndef _TAO_IDL_FEDERATORS_D2OPXO_CPP_
#define _TAO_IDL_FEDERATORS_D2OPXO_CPP_
...
/* Command-line: ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_OpenDDS_Federator_Manager_Perfect_Hash_OpTable -N lookup */
