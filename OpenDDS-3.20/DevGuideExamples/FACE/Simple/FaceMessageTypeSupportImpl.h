...
#ifndef OPENDDS_IDL_GENERATED_FACEMESSAGETYPESUPPORTIMPL_H_JUNBB2
#define OPENDDS_IDL_GENERATED_FACEMESSAGETYPESUPPORTIMPL_H_JUNBB2
...
template<> FaceMessenger_Export
const XTypes::TypeIdentifier& getMinimalTypeIdentifier<Messenger_Message_xtag>();

template<> FaceMessenger_Export
const XTypes::TypeMap& getMinimalTypeMap<Messenger_Message_xtag>();
...
#endif /* OPENDDS_IDL_GENERATED_FACEMESSAGETYPESUPPORTIMPL_H_JUNBB2 */
